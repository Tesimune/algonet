      ...
      <div className='grid md:grid-cols-3 gap-5 pt-9'>
        <div className='flex items-start'>
          ...
          <div className='grid gap-3'>
            <label className='font-bold text-3xl'>Data Driven</label>
        ...
        <div className='flex items-start'>
          ...
          <div className='grid gap-3'>
            <label className='font-bold text-3xl'>Innovation</label>
        ...
        <div className='flex items-start'>
          ...
          <div className='grid gap-3'>
            <label className='font-bold text-3xl'>Creativity</label>
