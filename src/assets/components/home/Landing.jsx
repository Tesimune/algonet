  ...
  return (
    <div>
      <section className='grid justify-start md:w-2/3 gap-5 py-16 px-5 md:px-28 text-white'>
        <span className='text-4xl md:text-5xl'>Connect your brand</span>
        ...
        <div className='grid gap-1'>
          <span className='text-xl'>Get the expertise and creativity.</span>
          <span className='text-xl'>needed to propel your business to the next level.</span>
        </div>
        <div className='pt-5'>
